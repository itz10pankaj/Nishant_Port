...
const Footer = () => {
  return (
    <footer className='w-full pt-20 pb-10 mb-[100px] md:mb-5' id='contact'>
        <div className='w-full absolute left-0 -bottom-68 min-h-96'>
            <img
                src='/footer-grid.svg'
                alt='grid'
        ...
        <div className='flex flex-col items-center'>
            ...
            <a href='mailto:ndjangra1027@gmail.com'>
                <MagicButton 
                    title='Get in touch'
        ...
        <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
            <p className='md:text-base text-sm md:font-normal font-light'>Copyright © {new Date().getFullYear()} Nishant</p>
